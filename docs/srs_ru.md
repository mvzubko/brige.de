...
Система должна быть построена на основе трёхуровневой архитектуры, которая включает клиентский уровень (frontend), серверный уровень (backend) и уровень базы данных.
...
#### 7.1.2. Серверный уровень (Application Layer, backend)
...
#### 7.1.3. Уровень базы данных (Database Layer)  
