...
| Функция | Описание |
| ------- | -------- |
| Заявка.Создание.Вариант1 | Пользователи с ролью "Оператор" или "Менеджер по продажам" могут создавать заявки, вводя необходимые данные о клиенте и сервисном технике, типе работы и планируемой дате визита. |
| Заявка.Создание.Вариант2 | Пользователи с ролью "Клиент" могут создавать заявки, вводя необходимые данные о себе и типе работы, которую они хотят заказать. |
| Заявка.Редактирование | Пользователи с ролью "Оператор" могут редактировать, либо дополнять существующие заявки, добавляя или изменяя информацию о клиенте, технике и типе работы. |
| Заявка.Удаление | Пользователи с ролью "Оператор" могут удалять заявки, если они не были выполнены или отменены. |
| Заявка.Поиск | Пользователи с ролью "Оператор" могут искать заявки по различным критериям, таким как номер заявки, имя клиента, дата визита и т.д. |
